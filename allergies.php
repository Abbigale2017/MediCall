...
<div class="container">
    ...
    <div class="divPanel page-content">
        ...
        <div class="breadcrumbs">
                <a href="index.html">Home</a> &nbsp;/&nbsp; <span>Allergies</span>
            </div> 
 ...
 Food, insect stings, and medications are common causes of severe reactions. Early exposure to potential allergens may be protective. Treatments for allergies include avoiding known allergens and the use of medications such as steroids and antihistamines. In severe reactions injectable adrenaline (epinephrine) is recommended. Allergen immunotherapy, which gradually exposes people to larger and larger amounts of allergen, is useful for some types of allergies such as hay fever and reactions to insect bites. Its use in food allergies is unclear.

Allergies are common. Rates of many allergic diseases appear to be increasing.</p>  
	            <p>    
                <a href="http://acaai.org/allergies/types" class="btn btn-primary btn-large">      Learn more    </a>  
                </p>            
            </div>
            <br />
            ...
            <p>
                <div class="alert alert-info">                          
	                <strong>Food:<strong> Allergies that arise from eating and digesting a certain food            
                </div>
                <div class="alert alert-info">                            
                    <strong>Seasonal:<strong> Allergies that arise from the weather or season              
                </div>
                <div class="alert alert-info">                           
                    <strong>Insect:<strong> Allergies that arise from being stung or biten by an insect
                </div>
                <div class="alert alert-info">                          
            ...
            <div class="accordion" id="accordion2">
                ...
                <div class="span4">
                    ...
                    <h4>Nose</h4>
                    <p>Swelling, runny nose, sneezing</p>

                    <h4>Eyes</h4>
                    <p>Redness, itching, watery</p>

                    <h4>Lungs and Throat</h4>
                    <p>Sneezing, coughing, wheezing, </p>
                
                    <h4>Ears</h4>
                    <p>Feeling full, pain, impaired hearing</p>

                    <h4>Skin</h4>
                    <p>Rashes, itching, inflammation</p>
                
                    <h4>Stomach</h4>
                    <p>Pain, bloating, vomiting, diarrhea</p>
